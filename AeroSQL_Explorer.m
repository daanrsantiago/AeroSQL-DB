...
AeroSQL_explorer.main_figure.Position = [400 250 1100 730];
...
global AeroSQL_explorer Polares Airfoils delimiter_dropdown
...
global AeroSQL_explorer Airfoils dir_exp form_exp delimiter inc_side geometria_perfil form_aquivo_dlg_box delimiter_dropdown Polares
...
elseif menu.Text == "&Formato dos arquivos"
	...
	form_aquivo_dlg_box.Position = [600 550 350 150];
	
	fmt_dropdown = uidropdown(form_aquivo_dlg_box,'Items',opc_possiveis,'ItemsData',1:length(opc_possiveis));
	fmt_dropdown.Position = [form_aquivo_dlg_box.Position(3)/2-120 100 100 25];
	...
	delimiter_dropdown.Position = [fmt_dropdown.Position(1)+145 100 100 25];
...
elseif menu.Text == "Polar Atual"
	...
	elseif form_exp == "mat"
		...
		eval([Airfoils.File_name{AeroSQL_explorer.Perfis_listbox.Value},'_',Source,'_',n_crit,'_',Mach,'_',Reynolds,' = Polar;'])
...
elseif menu.Text == "Todas as Polares do Perfil Atual"
	...
	elseif form_exp == "mat"
		...
		save([dir_exp,'\',Airfoils.File_name{AeroSQL_explorer.Perfis_listbox.Value},'_',Source,'_',n_crit,'_',Mach,'_',Reynolds,'.',char(form_exp)],[Airfoils.File_name{AeroSQL_explorer.Perfis_listbox.Value}])
	end
